...
//	--client-version <ver>   Codex client_version query value  (default: "0.156.1")
...
const (
	...
	defaultClientVersion     = "0.156.1"
	defaultCodexUserAgent    = "codex_cli_rs/" + defaultClientVersion + " (Mac OS 26.3.1; arm64) iTerm.app/3.6.9"
