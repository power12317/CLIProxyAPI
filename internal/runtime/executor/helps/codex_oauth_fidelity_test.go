...
func TestConfigureCodexChatGPTUsageRequestUsesSystemProfile(t *testing.T) {
	for _, test := range []struct {
		...
		{name: "legacy defaults to mac", wantUA: "codex-tui/0.156.1 (Mac OS 26.5.2; arm64) unknown (codex-tui; 0.156.1)"},
		{name: "windows", system: "windows", wantUA: "codex-tui/0.156.1 (Windows 10.0.19044; x86_64) unknown (codex-tui; 0.156.1)"},
	} {
