...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/codex-oailb-borrow", s.mgmt.GetCodexOaiLBBorrow)
		mgmt.PUT("/codex-oailb-borrow", s.mgmt.PutCodexOaiLBBorrow)
		mgmt.POST("/codex/oailb/borrow", s.mgmt.BorrowCodexOaiLB)
		mgmt.GET("/codex-turn-state-ticket", s.mgmt.GetCodexTurnStateTicket)
		mgmt.PUT("/codex-turn-state-ticket", s.mgmt.PutCodexTurnStateTicket)
		mgmt.PATCH("/codex-turn-state-ticket", s.mgmt.PutCodexTurnStateTicket)
		...
		mgmt.GET("/codex-capabilities", s.mgmt.GetCodexCapabilities)
